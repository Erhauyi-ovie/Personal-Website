...
const Data = () => {
  return (
    <div className='home__data'>
        ...
        <h3 className='home__subtitle'>Ethical Hacker</h3>
        <p className='home__description'>As a Certified Ethical Hacker, I specialize in identifying
        and mitigating security vulnerabilities to protect organizations from cyber threats</p>
        {/* <p className="hero--section-description">
             As a Certified Ethical Hacker, I specialize in identifying
             and mitigating security vulnerabilities to protect organizations from cyber threats
          </p> */}
